...
function Calculator() {
  ...
  const costOfAcdb = 3800;
  const costOfDcdb = 2500;
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.length > 0) {
            setSelectedVendor(response.data[0].id); // Set the default vendor ID here
          }
  ...
  const calculateSavings = () => {
    ...
    console.log("Calucate Clicked:", calculateClicked);
    ...
    let costOfBattery = installationCapacity * 7;
    ...
    // let priceOfPanels = newNumberOfPanels * pricePerPanel;
    // let costOfPanel =  newNumberOfPanels;
    ...
    setPanelCapacity(perUnitPanelCapacity);
    //setState(state);
  };
  ...
  const SolarQuotation = () => {
    return (
      ...
      >
        ...
        <TableContainer>
          <Table sx={{ xs: { minWidth: 400 } }} aria-label="spanning table">
            <TableHead>
              <TableRow>
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell>Cost of Brought Out Material</TableCell>
    ...
    <>
      ...
      >
        <Paper sx={{ m: 1, p: "2em" }}>
          ...
          >
            Sign up to get Detailed Quotation
          </Button>
        </Paper>
      </Box>
    </>
