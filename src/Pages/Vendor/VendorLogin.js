    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (isAuthenticated) {
          ...
          swal("Error", "You are not yet authorized. Please wait for authorization.", "error");
                        ...
                        {({ errors, touched }) => (
                          <Form>
                            ...
                            <p className="mb-1 pb-lg-2" style={{ color: "#393f81" }}>
                              Don't have an account? <Link to="/vendor-registration" style={{ color: "#393f81" }}>Register here</Link>
                            </p>
                          </Form>
                        )}
                      </Formik>
